                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="prefix" class="form-control" placeholder="prefix" value="4"/>
                        </div>
                    </div>
    ...
    $(document).ready(function() {
                ...
                $("#form").submit(function(e) {
                        ...
                        if ($("#Quantity").val() == null || $("#Quantity").val() == "" || parseInt($("#Quantity").val()) < 1) {
                            ...
                            if ($('#prefix').val()!= null && $('#prefix').val() != "" && $('#prefix').val() != "0")
                                prefix = $('#prefix').val()
                            if ($('#suffix').val() != null && $('#suffix').val() != "" && $('#suffix').val() != "0")
                                suffix = $('#suffix').val()
                            ...
                            pos_acentauri = new BigNumber(415344345654655213445845278);
                            ...
                            for (let index = 0; index < parseInt($("#Quantity").val()); index++) {
                                ...
                                var nm =  (parseInt(ini) + Math.floor(Math.random() * parseInt(lst))) 
