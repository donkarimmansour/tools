            ...
            <form id="form" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            <label for="list" class="control-label mb-1 required">Iban List</label>
                            <textarea id="list" class="form-control" placeholder="Iban List" rows="6"></textarea>
                            <small id="list_err" class="form-text text-danger d-none">Please Enter Iban List.</small>
                            ...
                            list.forEach(function(value, index) {
                                ...
                                ajaxCall = $.ajax({
                                    ...
                                    success: function(data) {
                                      ...
                                      //  var is = !data["valid"] ? "invalid" : "valid"

                                       // document.getElementById("okay").innerHTML += value + " | " + is + $("#separator").val();
